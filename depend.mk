...
LINK_FLAGS += -lm -lm -lmlx -lm -lm -lm
MAINS += rtv1
...
PUBLIC_LINKS += $(O_DIR)/_public/ft/ft_colors.h $(O_DIR)/_public/ft/ft_wchar.h \
	...
	$(O_DIR)/_public/scene_renderer.h $(O_DIR)/_public/texture_loader.h
...
rtv1: $(O_DIR)/libft/ft_base/ft_subnext.o $(O_DIR)/libft/ft_base/ft_memcpy.o \
	...
	$(O_DIR)/libft/ft_out/ft_write_char.o $(O_DIR)/libft/ft_vector/ft_vclear.o \
	$(O_DIR)/libft/ft_img_loader/ft_load_img.o \
	$(O_DIR)/libft/ft_math/ft_mat3transpose.o \
	...
	$(O_DIR)/libft/ft_set/utils.o $(O_DIR)/srcs/obj_types/sphere.o \
	...
	$(O_DIR)/srcs/ray_tracer/nearest_intersect.o \
	$(O_DIR)/libft/ft_base/ft_abs.o $(O_DIR)/srcs/mlx_win/ft_mlx_open.o \
	$(O_DIR)/libft/ft_base/ft_wstrconv.o $(O_DIR)/libft/ft_printf/args_utils.o \
	$(O_DIR)/libft/ft_math/ft_mat4reflect.o $(O_DIR)/libft/ft_base/ft_min.o \
...
$(O_DIR)/srcs/main/main.o: srcs/main/main.c libft/ft_base/public/ft_colors.h \
	...
	srcs/scene_renderer/public/scene_renderer.h
